...
hi User1            cterm=none       ctermbg=236 ctermfg=223
...
hi NonText          cterm=none       ctermbg=233 ctermfg=241
...
hi IncSearch        cterm=none       ctermbg=63  ctermfg=232
hi Search           cterm=none       ctermbg=36  ctermfg=232
hi Visual           cterm=none       ctermbg=24
hi WildMenu         cterm=none       ctermbg=35  ctermfg=232
hi ModeMsg          cterm=none                   ctermfg=110
hi MoreMsg          cterm=none                   ctermfg=121
hi Question         cterm=none                   ctermfg=121
...
hi Title            cterm=none                   ctermfg=147
...
hi MatchParen       cterm=none       ctermbg=24
...
hi Constant         cterm=none                   ctermfg=215
 hi String          cterm=none                   ctermfg=215
 hi Character       cterm=none                   ctermfg=215
...
hi Statement        cterm=none                   ctermfg=63
 hi Exception       cterm=none                   ctermfg=99
...
hi Special          cterm=none                   ctermfg=87
hi Underlined       cterm=underline              ctermfg=227
hi Ignore           cterm=none                   ctermfg=235
hi Error            cterm=none       ctermbg=52  ctermfg=231
hi Todo             cterm=none       ctermbg=143 ctermfg=16

hi OperatorCurlyBrackets cterm=none ctermfg=75

" highlight modes
autocmd InsertEnter * hi StatusLine ctermbg=236
autocmd InsertEnter * hi User1      ctermbg=236
autocmd InsertEnter * hi User2      ctermbg=236
...
autocmd CmdwinEnter * hi StatusLine ctermbg=236
autocmd CmdwinEnter * hi User1      ctermbg=236
autocmd CmdwinEnter * hi User2      ctermbg=236
...
hi rubyPredefinedIdentifier gui=none                   guifg=#5f8700
hi def link rubyStringDelimiter String
...
hi User1            gui=none       guibg=#303030 guifg=#ffdfaf
...
hi NonText          gui=none       guibg=#121212 guifg=#606060
...
hi IncSearch        gui=none       guibg=#5f5fff  guifg=#080808
hi Search           gui=none       guibg=#00af87  guifg=#080808
hi Visual           gui=none       guibg=#005f87
hi WildMenu         gui=none       guibg=#00af5f  guifg=#080808
hi ModeMsg          gui=none                   guifg=#87afdf
hi MoreMsg          gui=none                   guifg=#87ffaf
hi Question         gui=none                   guifg=#87ffaf
...
hi Title            gui=none                   guifg=#afafff
...
hi MatchParen       gui=none       guibg=#005f87
...
hi Constant         gui=none                   guifg=#ffaf5f
 hi String          gui=none                   guifg=#ffaf5f
 hi Character       gui=none                   guifg=#ffaf5f
